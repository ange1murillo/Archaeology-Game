...
function GameBoard()
{
 ...
 this.ruins = [

  {
    ...
    size: 5,
    successes: 0,
		picture: '<img src="images/palace.png" style = "width: 25px; height:25px">'
  },

  {
    ...
    size: 4,
    successes: 0,
		picture: '<img src="images/temple.png" style = "width: 25px; height:25px">'
  },

  {
    ...
    size: 4,
    successes: 0,
		picture: '<img src="images/hotel.png" style = "width: 25px; height:25px">'
  },

  {
    ...
    size: 3,
    successes: 0,
		picture: '<img src="images/house.png" style = "width: 25px; height:25px">'
  },

  {
    ...
    size: 2,
    successes: 0,
		picture: '<img src="images/hut.jpg" style = "width: 25px; height:25px">'
  }
